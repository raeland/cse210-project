...
namespace OnlineOrder
{
    public class Program
    {
        ...
        {
            Address address1 = new Address("123 Main St", "Philedelphia", "PA", "USA");
            Customer customer1 = new Customer("Hopper Roger", address1);

            Address address2 = new Address("456 Part Ave", "Hollywood", "FL", "USA");
            Customer customer2 = new Customer("Buddy Rusty", address2);
